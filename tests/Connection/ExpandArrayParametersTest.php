...
class ExpandArrayParametersTest extends TestCase
{
    ...
    public static function dataExpandListParameters(): iterable
    {
        ...
        yield 'Positional: One non-list before d one after list-needle' => [
        ...
        yield 'Positional: One non-list after list-needle' => [
        ...
        yield 'Positional: One non-list before and one after list-needle' => [
        ...
        yield 'Positional: Empty "integer" array (DDC-1978)' => [
            'SELECT * FROM Foo WHERE foo IN (?)',
            [[]],
            [ArrayParameterType::INTEGER],
        ...
        yield 'Positional: Empty "str" array (DDC-1978)' => [
            'SELECT * FROM Foo WHERE foo IN (?)',
            [[]],
        ...
        yield 'Positional: explicit keys for params and types' => [
        ...
        yield 'Positional: explicit keys for array params and array types' => [
        ...
        yield 'Named: Very simple with param int' => [
        ...
        yield 'Named: Very simple with param int and string' => [
        ...
        yield 'Named: Very simple with one needle' => [
        ...
        yield 'Named: One non-list before d one after list-needle' => [
        ...
        yield 'Named: One non-list after list-needle' => [
        ...
        yield 'Named: One non-list before and one after list-needle' => [
        ...
        yield 'Named: With the same name arg type string' => [
        ...
        yield 'Named: With the same name arg' => [
        ...
        yield 'Named: Same name, other name in between (DBAL-299)' => [
        ...
        yield 'Named: Empty "integer" array (DDC-1978)' => [
            'SELECT * FROM Foo WHERE foo IN (:foo)',
            ['foo' => []],
            ['foo' => ArrayParameterType::INTEGER],
            'SELECT * FROM Foo WHERE foo IN (NULL)',
        ...
        yield 'Named: Two empty "str" array (DDC-1978)' => [
        ...
        yield 'Named parameters and partially implicit types' => [
        ...
        yield 'Named parameters and explicit types' => [
            'SELECT * FROM Foo WHERE foo = :foo OR bar = :bar',
            ['foo' => 'foo', 'bar' => 'bar'],
            ['foo' => ParameterType::INTEGER, 'bar' => ParameterType::INTEGER],
            'SELECT * FROM Foo WHERE foo = ? OR bar = ?',
        ...
        yield 'Null valued parameters (DBAL-522)' => [
        ...
        yield 'Escaped single quotes SQL- and C-Style (DBAL-1205)' => [
        ...
        yield 'Named: Binary array with explicit types' => [
            'SELECT * FROM Foo WHERE foo IN (:foo) OR bar IN (:bar)',
            [
